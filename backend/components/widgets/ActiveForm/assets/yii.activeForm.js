...
(function ($) {
    ...
    var updateInput = function ($form, attribute, messages) {
        ...
        if ($input.length) {
            ...
            var $tab = $('a[href="#'+$container.parent().attr('id')+'"]'),
                tabErrorClass= 'text-red',
                tabSuccessClass= 'text-green';
            if (hasError) {
                ...
                $tab.removeClass(tabSuccessClass)
                    .addClass(tabErrorClass);
            } else {
                $error.empty();
                $container.removeClass(data.settings.validatingCssClass + ' ' + data.settings.errorCssClass + ' ')
                    .addClass(data.settings.successCssClass);
                $tab.removeClass(tabErrorClass)
                    .addClass(tabSuccessClass);
            }
